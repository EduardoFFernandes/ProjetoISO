...
public class Constantes {
	...
	public static final String NAO_SELECIONADO_PROCESSOS = "Nao foi selecionado os Processos.";
	public static final String NAO_SELECIONADO_ARQUIVOS = "Nao foi selecionado os Arquivos.";
