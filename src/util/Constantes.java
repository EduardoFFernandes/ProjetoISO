...
public class Constantes {
	...
	public static String NAO_SELECIONADO_PROCESSOS = "Nao foi selecionado os Processos.";
	public static String NAO_SELECIONADO_ARQUIVOS = "Nao foi selecionado os Arquivos.";
	...
	public static String JAVA_PNG = "java.png";
